                    ...
                    children: [
                      listRecipesSize != 0
                          ? Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                      "Receitas Encontradas ($listRecipesSize)",
                      ...
                      Column(
                        children: recipeResultController.listRecipesResult[0]
                            .take(10)
                            .map<RecipeTile>((element) => RecipeTile(
                                  recipe: element as Recipe,
                                  isMyRecipe:
                                      userController.isMyRecipe(element),
                                ))
                            .toList(),
                      ),
