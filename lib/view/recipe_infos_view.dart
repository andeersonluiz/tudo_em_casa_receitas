...
class _RecipeInfosViewState extends State<RecipeInfosView> with RouteAware {
  ...
  void initState() {
    if (Get.arguments != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        await recipeInfosController.loadData(Recipe.fromJson(
            Get.arguments["recipe"], Get.arguments["recipe"]["id"],
            isFavorite: isFavorite, isLiked: isLiked));
        print("abc");
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        if (recipe == null) {
          ...
          GFToast.showToast(
              backgroundColor: context.theme.textTheme.titleMedium!.color!,
              textStyle: TextStyle(
  ...
  Widget build(BuildContext context) {
    print("refiz $isLoading");
    print("isPreview $isPreview");
    print(Get.parameters['data']);
    if (isLoading) {
      return SafeArea(child: LoaderTile(size: GFSize.LARGE));
    }
    return SafeArea(
                  ...
                  child: CircleAvatar(
                    ...
                    child: IconButton(
                      ...
                      onPressed: isPreview
                          ...
                          : () async {
                              var url =
                                  await recipeInfosController.generateShorUrl();
                              Share.share(
                        ...
                        return GFButton(
                            ...
                            onPressed: () {
                              if (userController.currentUser.value.id != "") {
                                ...
                                likeController.setLike(recipeInfosController
                                    .recipeSelected.value!);
                              } else {
                                GFToast.showToast(
                                    backgroundColor: context
